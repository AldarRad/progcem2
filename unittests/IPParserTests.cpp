...
TEST(TestIPParser, test_txt_1)
{
    ...
    IPParser::parseFile("D:\\program\\labs2\\unittests\\IP\\test1.txt", testIP);
    IPStruct temp;
    bool flag = true;
    temp[0] = 123; temp[1] = 123; temp[2] = 123; temp[3] = 123;
    rightIP.push_back(temp);
    temp[0] = 91; temp[1] = 64; temp[2] = 189; temp[3] = 196;
    rightIP.push_back(temp);
    temp[0] = 93; temp[1] = 179; temp[2] = 90; temp[3] = 82;
    rightIP.push_back(temp);
    for(int i =0; i < 3; ++i)
    {
